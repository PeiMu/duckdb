...
log_name=hyperfine_convert_postgres_plan_query_split.txt
...
#dir="$JOB_PATH/queries_without_AS_QuerySplit"
dir="$JOB_PATH/QuerySplit/queries_new_settings_QuerySplit"
iteration=10
