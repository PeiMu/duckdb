...
bash ./measure_optimizer_comparison_time_job.sh query_split 0.10.1
bash ./measure_optimizer_comparison_time_job.sh whole_query 1.3.2
bash ./measure_optimizer_comparison_time_job.sh query_split 1.3.2
```
